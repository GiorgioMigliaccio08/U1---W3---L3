...
const crazyConcatStrings = function (s1, s2) {
  return s1.slice(0, 2).concat(s2.slice(s2.lenght - 3, s2.lenght));
};
...
const numericArray = [5, 8, 78, 45, 32, 77, 88, 54, 82, 100];
...
const numeriArray = [1, 2, 3, 4, 5, 6, 7];
const filterNumber = numeriArray.filter((currentValue) => {
  return currentValue % 2 === 0;
});
console.log("Numeri pari:", filterNumber);
/* ESERCIZIO 4 (forEach)
...
const numeriArray2 = [1, 9, 3, 88, 5, 6, 7];
const somma = numeriArray2.reduce((accumulatore, n) => {
  return accumulatore + n;
}, 0);
...
console.log(incrementArray([5, 9, 5, 8], 4));
